...
st.markdown("O simulador carregou automaticamente os dados da sua operação.")
...
try:
    ...
    st.error(f"⚠️ Erro ao ler o Excel! Certifique-se de que o ficheiro '{file_path}' está na mesma pasta que este script. Detalhe: {e}")
    st.stop()
