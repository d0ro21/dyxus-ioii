...
uploaded_file = st.file_uploader(t("Arraste e solte o ficheiro Excel (.xlsx) aqui", "Drag and drop the Excel file (.xlsx) here"), type=["xlsx"])
...
if uploaded_file is not None:
    try:
        ...
        st.error(t(f"⚠️ Erro ao ler o Excel! Certifique-se de que tem as abas corretas. Detalhe: {e}", 
                   f"⚠️ Error reading Excel! Make sure you have the correct sheets. Detail: {e}"))
        st.stop()
    ...
    st.info(t("👆 Por favor, carregue o ficheiro Excel com os dados do 'Burrito Game'.", "👆 Please upload the Excel file with the 'Burrito Game' data."))
